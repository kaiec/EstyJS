...
EstyJS 2.0 has been maintained by [Kai Eckert](https://github.com/kaiec/EstyJS) since 2024. EstyJS
1.0 (2013 - 2024) was written by [Darren Coles](https://github.com/dmcoles/EstyJs).

Further credits:
- The **68000 emulation core** is by Rupert Hausberger, adapted from
  [SAE](http://scriptedamigaemulator.net/) by Darren Coles.
- [**EmuTOS**](https://emutos.sourceforge.io/) is the open source implementation of the original
  Atari TOS operating system, used by default in EstyJS (but the original TOS works, too).
